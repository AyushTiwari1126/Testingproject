...
public class GetCardInfo 
{
   ...
   @BeforeTest
	...
	public void TGCI001() throws IOException, ParseException 
	{           //Validate the response after providing valid header with valid request body
                
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\cardManagement\\GetCardInfo\\TGCI001.json");
				...
				//get response
				response = httpsRequest.request(Method.POST, UtilityClass.getDataFromPF("getCardInfoEndPontUrl"));
		       ...
		       //2.validate cardId in response
				softassert.assertEquals(response.jsonPath().getString("responseData.cardId"),jsonObject.get("ExpectedcardId"));
				if(jsonObject.get("ExpectedcardId").toString().equals(response.jsonPath().getString("responseData.cardId")))
				{
					test.log(Status.PASS," Response cardId and Expected cardId match ");
				}
				else 
				{
					test.log(Status.FAIL," Response cardId and Expected cardId not match ");
				}
	...
	{           //Validate the response with ReqDatetime header value blank
		        ...
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\cardManagement\\GetCardInfo\\TH001.json");
	...
	{           //Validate the response with Sign header value blank 
		        ...
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\cardManagement\\GetCardInfo\\TH002.json");
	...
	{           //Validate the response with Authorization header value blank         
		        ...
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\cardManagement\\GetCardInfo\\TH003.json");
	...
	{           //Validate the response without ReqDatetime header
		        ...
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\cardManagement\\GetCardInfo\\TH004.json");
	...
	{           //Validate the response without Sign Header.
		        ...
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\cardManagement\\GetCardInfo\\TH005.json");
	...
	{           //Validate the response without Authorization header
		        ...
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\cardManagement\\GetCardInfo\\TH006.json");
	...
	{           //Validate the response after providing  all header  without value
		        ...
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\cardManagement\\GetCardInfo\\TH007.json");
	...
	public void TGCI002() throws IOException, ParseException 
	{           //Validate the response after providing blank request body
                
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\cardManagement\\GetCardInfo\\TGCI002.json");
			   ...
			   //ADD test case Description in test report
				...
				//get response
				response = httpsRequest.request(Method.POST, UtilityClass.getDataFromPF("getCardInfoEndPontUrl"));
				System.out.println("TGCI002"+response.asString());
	...
	public void TGCI003() throws IOException, ParseException 
	{           //Validate the response after providing blank value in cardId node 
                
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\cardManagement\\GetCardInfo\\TGCI003.json");
				...
				//get response
				response = httpsRequest.request(Method.POST, UtilityClass.getDataFromPF("getCardInfoEndPontUrl"));
				System.out.println("TGCI003"+response.asString());
	...
	public void TGCI004() throws IOException, ParseException 
	{           //Validate the response after providing spaces  in cardId node
                
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\cardManagement\\GetCardInfo\\TGCI004.json");
				...
				//get response
				response = httpsRequest.request(Method.POST, UtilityClass.getDataFromPF("getCardInfoEndPontUrl"));
				System.out.println("TGCI004"+response.asString());
	...
	public void TGCI005() throws IOException, ParseException 
	{           //Validate the response after  providing invalid cardId (which not present in database)
                
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\cardManagement\\GetCardInfo\\TGCI005.json");
	...
	public void TGCI006() throws IOException, ParseException 
	{           //Validate the response after providing valid (max-1=18) numbers in cardId
                
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\cardManagement\\GetCardInfo\\TGCI006.json");
				...
				//get response
				response = httpsRequest.request(Method.POST, UtilityClass.getDataFromPF("getCardInfoEndPontUrl"));
				System.out.println("TGCI006"+response.asString());
