...
public class departmentStatus {
	...
	public void TDS001() throws IOException, ParseException {
// Validate response after providing valid headers with valid request body

		// Read data from json file
		jsonObject = UtilityClass
				.readDataFromJSONFile(dirPath + "//Test_Data//department_management//DepartmentStatus//TDS001.json");
		...
		// Response Object
		response = httpsRequest.request(Method.PUT, UtilityClass.getDataFromPF("departmentStatusEndPointUrl"));
...
// To validate the response for valid request body with headers (takes ReqDatetime as blank) 
		...
		// Read data from json file
		jsonObject = UtilityClass
				.readDataFromJSONFile(dirPath + "//Test_Data//department_management//DepartmentStatus//TH001.json");
...
// To validate the response after providing valid request body with headers (takes sign as blank)
		...
		// Read data from json file
		jsonObject = UtilityClass
				.readDataFromJSONFile(dirPath + "//Test_Data//department_management//DepartmentStatus//TH002.json");
...
// To validate the response for valid request body with header (takes authorization as blank)
		...
		// Read data from json file
		jsonObject = UtilityClass
				.readDataFromJSONFile(dirPath + "//Test_Data//department_management//DepartmentStatus//TH003.json");
...
// To validate the response for valid request body with header (without reqDatetime)
		...
		// Read data from json file
		jsonObject = UtilityClass
				.readDataFromJSONFile(dirPath + "//Test_Data//department_management//DepartmentStatus//TH004.json");
...
// To validate the response for valid request body with header (without sign header)
		...
		// Read data from json file
		jsonObject = UtilityClass
				.readDataFromJSONFile(dirPath + "//Test_Data//department_management//DepartmentStatus//TH005.json");
...
// To validate the response for valid request body with header (without authorization header)
		...
		// Read data from json file
		jsonObject = UtilityClass
				.readDataFromJSONFile(dirPath + "//Test_Data//department_management//DepartmentStatus//TH006.json");
...
// To validate the response after providing valid request body without any header value
		...
		// Read data from json file
		jsonObject = UtilityClass
				.readDataFromJSONFile(dirPath + "//Test_Data//department_management//DepartmentStatus//TH007.json");
...
// ------------Assertions-----------------
	...
	public void TDS002() throws IOException, ParseException {
// Validate the response after passing the invalid departmentId (non-existent departmentId)

		// Read data from json file
		jsonObject = UtilityClass
				.readDataFromJSONFile(dirPath + "//Test_Data//department_management//DepartmentStatus//TDS002.json");
...
// ---------------Assertions-----------------
		...
		// Assertion-4 : To validate the departmentID
		softassert.assertTrue(response.jsonPath().getString("errorDetail.errorMessage[1]")
				.contains(jsonObject.get("ExpectedDeptId").toString()));
		if (response.jsonPath().getString("errorDetail.errorMessage[1]")
				.contains(jsonObject.get("ExpectedDeptId").toString())) {
			test.log(Status.PASS, "Actual departmentId- " + jsonObject.get("ExpectedDeptId")
					+ " is same as the expected departmentId");
		} else {
			test.log(Status.FAIL,
					"We expect the departmentId- " + jsonObject.get("ExpectedDeptId") + " is not present in response");
		}
		softassert.assertAll();
	}

	@Test(priority = 11, dependsOnMethods = { "Token_Generation" })
	public void TDS003() throws IOException, ParseException {
// Validate the response after updating the same status again that is already updated

		// Read data from json file
		jsonObject = UtilityClass
				.readDataFromJSONFile(dirPath + "//Test_Data//department_management//DepartmentStatus//TDS003.json");
...
// ---------------Assertions-----------------
	...
	public void TDS004() throws IOException, ParseException {
// To validate the response after providing valid request body (to deactivate the branch status : "D")

		// Read data from json file
		jsonObject = UtilityClass
				.readDataFromJSONFile(dirPath + "//Test_Data//department_management//DepartmentStatus//TDS004.json");
...
// ---------------Assertions-----------------
	...
	public void TDS005() throws IOException, ParseException {
// Validate the response after providing any other character except 'A', 'D' & 'I' in StatusCode with valid headers 

		// Read data from json file
		jsonObject = UtilityClass
				.readDataFromJSONFile(dirPath + "//Test_Data//department_management//DepartmentStatus//TDS005.json");
...
// ---------------Assertions-----------------
	...
	public void TDS006() throws IOException, ParseException {
// To validate the response after passing integer typed value into departmentId 

		// Read data from json file
		jsonObject = UtilityClass
				.readDataFromJSONFile(dirPath + "//Test_Data//department_management//DepartmentStatus//TDS006.json");
...
// ---------------Assertions-----------------
	...
	public void TDS007() throws IOException, ParseException {
// To validate the response after providing the float/double typed value into departmentId

		// Read data from json file
		jsonObject = UtilityClass
				.readDataFromJSONFile(dirPath + "//Test_Data//department_management//DepartmentStatus//TDS007.json");
...
// ---------------Assertions-----------------
	...
	public void TDS008() throws IOException, ParseException {
// Validate response after providing the request body (pass special characters which we are used to create department)

		// Read data from json file
		jsonObject = UtilityClass
				.readDataFromJSONFile(dirPath + "//Test_Data//department_management//DepartmentStatus//TDS008.json");
...
// ---------------Assertions-----------------
	...
	public void TDS009() throws IOException, ParseException {
// Validate response after providing valid headers with request body (takes all nodes as blank)

		// Read data from json file
		jsonObject = UtilityClass
				.readDataFromJSONFile(dirPath + "//Test_Data//department_management//DepartmentStatus//TDS009.json");
...
// ---------------Assertions-----------------
	...
	public void TDS010() throws IOException, ParseException {
// Validate response after providing valid headers with request body (takes spaces in all nodes)

		// Read data from json file
		jsonObject = UtilityClass
				.readDataFromJSONFile(dirPath + "//Test_Data//department_management//DepartmentStatus//TDS010.json");
...
// ---------------Assertions-----------------
	...
	public void TDS011() throws IOException, ParseException {
// To validate the response for passing length more than 2 characters into departmentId

		// Read data from json file
		jsonObject = UtilityClass
				.readDataFromJSONFile(dirPath + "//Test_Data//department_management//DepartmentStatus//TDS011.json");
