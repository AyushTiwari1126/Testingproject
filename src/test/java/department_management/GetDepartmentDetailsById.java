...
public class GetDepartmentDetailsById {
	...
	RequestSpecification httpsRequest, httpsRequest_Token;
	...
	public void TDDI001() throws IOException, ParseException {
// Validate the response for valid testcases with valid headers

		// Read data from json file
		jsonObject = UtilityClass.readDataFromJSONFile(
				dirPath + "//Test_Data//department_management//GetDepartmentDetailsById//TDDI001.json");
		...
		// Response Object
		response = httpsRequest.request(Method.POST, UtilityClass.getDataFromPF("getDepartmentDetailsByIdEndPointUrl"));
...
// ---------------Assertions-----------------
		...
		if (response.jsonPath().get("responseCode").equals(jsonObject.get("ExpectedResponseCode"))) {
			test.log(Status.PASS, "Expected Response code is same as actual response code - 000");
		} else {
		...
		if (Integer.toString(response.getStatusCode()).equals(jsonObject.get("ExpectedHTTPStatusCode"))) {
			test.log(Status.PASS, "Expected Status code is same as actual status code - 200");
		} else {
		...
		softassert.assertEquals(response.jsonPath().getString("responseData[0].status"),
				jsonObject.get("ExpectedDeptstatus"));
		if (response.jsonPath().getString("responseData[0].status").equals(jsonObject.get("ExpectedDeptstatus"))) {
			test.log(Status.PASS, "Actual department status- " + response.jsonPath().getString("responseData[0].status")
			...
			test.log(Status.FAIL,
					"We expect the department status- " + jsonObject.get("ExpectedDeptstatus")
							...
							+ response.jsonPath().getString("responseData[0].status"));
		}

		// Assertion-5 : To validate the departmentID
		softassert.assertEquals(response.jsonPath().getString("responseData[0].departmentId"),
				jsonObject.get("ExpectedDeptId"));
		if (response.jsonPath().getString("responseData[0].departmentId").equals(jsonObject.get("ExpectedDeptId"))) {
			test.log(Status.PASS,
					"Actual departmentId- " + response.jsonPath().getString("responseData[0].departmentId")
			...
			test.log(Status.FAIL,
					"We expect the departmentId- " + jsonObject.get("ExpectedDeptId")
							...
							+ response.jsonPath().getString("responseData[0].departmentId"));
		}
		softassert.assertAll();
	}
...
// To validate the response for valid request body with headers (takes ReqDatetime as blank) 
		...
		jsonObject = UtilityClass
				.readDataFromJSONFile(
						dirPath + "//Test_Data//department_management//GetDepartmentDetailsById//TH001.json");
...
// To validate the response after providing valid request body with headers (takes sign as blank)
		...
		jsonObject = UtilityClass
				.readDataFromJSONFile(
						dirPath + "//Test_Data//department_management//GetDepartmentDetailsById//TH002.json");
...
// To validate the response for valid request body with header (takes authorization as blank)
		...
		jsonObject = UtilityClass
				.readDataFromJSONFile(
						dirPath + "//Test_Data//department_management//GetDepartmentDetailsById//TH003.json");
...
// To validate the response for valid request body with header (without reqDatetime)
		...
		jsonObject = UtilityClass
				.readDataFromJSONFile(
						dirPath + "//Test_Data//department_management//GetDepartmentDetailsById//TH004.json");
...
// To validate the response for valid request body with header (without sign header)
		...
		jsonObject = UtilityClass
				.readDataFromJSONFile(
						dirPath + "//Test_Data//department_management//GetDepartmentDetailsById//TH005.json");
...
// To validate the response for valid request body with header (without authorization header)
		...
		jsonObject = UtilityClass
				.readDataFromJSONFile(
						dirPath + "//Test_Data//department_management//GetDepartmentDetailsById//TH006.json");
...
// To validate the response after providing valid request body without any header value
		...
		jsonObject = UtilityClass
				.readDataFromJSONFile(
						dirPath + "//Test_Data//department_management//GetDepartmentDetailsById//TH007.json");
...
// ------------Assertions-----------------
	...
	public void TDDI002() throws IOException, ParseException {
// To validate the response after passing the invalid departmentId (which is not present into the database)

		// Read data from json file
		jsonObject = UtilityClass.readDataFromJSONFile(
				dirPath + "//Test_Data//department_management//GetDepartmentDetailsById//TDDI002.json");
...
// ---------------Assertions-----------------
	...
	public void TDDI003() throws IOException, ParseException {
// To validate the response after pass spaces only into the departmentId

		// Read data from json file
		jsonObject = UtilityClass.readDataFromJSONFile(
				dirPath + "//Test_Data//department_management//GetDepartmentDetailsById//TDDI003.json");
...
// ---------------Assertions-----------------
	...
	public void TDDI004() throws IOException, ParseException {
// Validate the response for checking the status of departmentId having special characters

		// Read data from json file
		jsonObject = UtilityClass.readDataFromJSONFile(
				dirPath + "//Test_Data//department_management//GetDepartmentDetailsById//TDDI004.json");
...
// ---------------Assertions-----------------
	...
	public void TDDI005() throws IOException, ParseException {
// To validate the response for kept the departmentId as blank

		// Read data from json file
		jsonObject = UtilityClass.readDataFromJSONFile(
				dirPath + "//Test_Data//department_management//GetDepartmentDetailsById//TDDI005.json");
...
// ---------------Assertions-----------------
	...
	public void TDDI006() throws IOException, ParseException {
// To validate the response for passing more than max(2-digits) in departmentId

		// Read data from json file
		jsonObject = UtilityClass.readDataFromJSONFile(
				dirPath + "//Test_Data//department_management//GetDepartmentDetailsById//TDDI006.json");
...
// ---------------Assertions-----------------
	...
	public void TDDI007() throws IOException, ParseException {
// Validate the response after pass nothing into the request body

		// Read data from json file
		jsonObject = UtilityClass.readDataFromJSONFile(
				dirPath + "//Test_Data//department_management//GetDepartmentDetailsById//TDDI007.json");
...
// ---------------Assertions-----------------
	...
	public void TDDI008() throws IOException, ParseException {
// To validate the response after passing the integer typed value into departmentId

		// Read data from json file
		jsonObject = UtilityClass.readDataFromJSONFile(
				dirPath + "//Test_Data//department_management//GetDepartmentDetailsById//TDDI008.json");
...
// ---------------Assertions-----------------
	...
	public void TDDI009() throws IOException, ParseException {
// To validate the response after passing the float/double typed value into departmentId

		// Read data from json file
		jsonObject = UtilityClass.readDataFromJSONFile(
				dirPath + "//Test_Data//department_management//GetDepartmentDetailsById//TDDI009.json");
