...
public class GetAllDepartment {
	...
	public void TGAD001() throws IOException, ParseException {
// Validate response after providing valid headers with valid request body

		// Read data from json file
		jsonObject = UtilityClass
				.readDataFromJSONFile(dirPath + "//Test_Data//department_management//GetAllDepartment//TGAD001.json");
		...
		// Response Object
		response = httpsRequest.request(Method.POST, UtilityClass.getDataFromPF("getAllDepartmentEndPointUrl"));
...
// Validate response after providing valid request body with valid header (takes ReqDatetime as blank)
		...
		jsonObject = UtilityClass
				.readDataFromJSONFile(dirPath + "//Test_Data//department_management//GetAllDepartment//TH001.json");
