...
public void TGCS001() throws IOException, ParseException 
{           //Validate the response after providing valid header with valid request body
            
	        //read data from json file
			jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getCustomerStatus\\TGCS001.json");
			...
			//get response
			response = httpsRequest.request(Method.POST, UtilityClass.getDataFromPF("getCustomerStatusEndPointUrl"));
...
{           //Validate the response with ReqDatetime header value blank
	        ...
	        //read data from json file
			jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getCustomerStatus\\TH001.json");
...
{           //Validate the response with Sign header value blank 
	        ...
	        //read data from json file
			jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getCustomerStatus\\TH002.json");
...
{           //Validate the response with Authorization header value blank         
	        ...
	        //read data from json file
			jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getCustomerStatus\\TH003.json");
...
{           //Validate the response without ReqDatetime header
	        ...
	        //read data from json file
			jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getCustomerStatus\\TH004.json");
...
{           //Validate the response without Sign Header.
	        ...
	        //read data from json file
			jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getCustomerStatus\\TH005.json");
...
{           //Validate the response without Authorization header
	        ...
	        //read data from json file
			jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getCustomerStatus\\TH006.json");
...
{           //Validate the response after providing  all header  without value
	        ...
	        //read data from json file
			jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getCustomerStatus\\TH007.json");
...
public void TGCS002() throws IOException, ParseException 
{           // validate the response with blank request body
            
	        //read data from json file
			jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getCustomerStatus\\TGCS002.json");
...
public void TGCS003() throws IOException, ParseException 
{           //Validate the response after providing  blank value in customerId
            
	        //read data from json file
			jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getCustomerStatus\\TGCS003.json");
...
public void TGCS004() throws IOException, ParseException 
{           //Validate the response after providing spaces in customerId node
            
	        //read data from json file
			jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getCustomerStatus\\TGCS004.json");
...
public void TGCS005() throws IOException, ParseException 
{           //Validate the response after providing  invalid customerId (not present on server)
            
	        //read data from json file
			jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getCustomerStatus\\TGCS005.json");
...
public void TGCS006() throws IOException, ParseException 
{           //Validate the response after providing invalid customerId(length max+1)
            
	        //read data from json file
			jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getCustomerStatus\\TGCS006.json");
...
public void TGCS007() throws IOException, ParseException 
{           //Validate the response after providing invalid customerId(length max-1=19)
            
	        //read data from json file
			jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getCustomerStatus\\TGCS007.json");
