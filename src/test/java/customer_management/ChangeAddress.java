...
public class ChangeAddress {
   ...
   @BeforeTest
	...
	public void TCA001() throws IOException, ParseException 
	{          //Validate the response after providing valid header with valid request body.
		         
		       //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA001.json");
				...
				//get response
				response = httpsRequest.request(Method.PUT, UtilityClass.getDataFromPF("changeAddressEndPontUrl"));
	...
	public void TCA002() throws IOException, ParseException 
	{           //Validate the response after providing <br>blank customerId with valid request body
		       
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA002.json");
	...
	public void TCA003() throws IOException, ParseException 
	{           //Validate the response after providing all field in newAddress node blank.
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA003.json");
	...
	public void TCA004() throws IOException, ParseException 
	{           //Validate the response after providing spaces<br> in customerId node. 
	            
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA004.json");
	...
	public void TCA006() throws IOException, ParseException 
	{           //Validate the response after providing addressType(H,C,P,S)  in request body. 
		        
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA006.json");
				...
				//get response
				response = httpsRequest.request(Method.PUT, UtilityClass.getDataFromPF("changeAddressEndPontUrl"));
				System.out.println("6"+response.asString());
	...
	public void TCA007() throws IOException, ParseException 
	{           //Validate the response after providing invalid addressType(exclude H,C,P,S)in request body
		        
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA007.json");
	...
	public void TCA008() throws IOException, ParseException 
	{           //Validate the response after providing invalid addressType (int) in request body
		        
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA008.json");
	...
	public void TCA009() throws IOException, ParseException 
	{           //Validate the response after providing blank in addressType in request body
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA009.json");
	...
	public void TCA010() throws IOException, ParseException 
	{           //Validate the response after providing spaces in addressType in request body
		        
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA010.json");
			    ...
			    //get response
				response = httpsRequest.request(Method.PUT, UtilityClass.getDataFromPF("changeAddressEndPontUrl"));
				System.out.println("10"+response.asString());
	...
	public void TCA011() throws IOException, ParseException 
	{           //Validate the response after providing invalid customerId(max+1) 21 character string in request body
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA011.json");
			    ...
			    //1.validate http status code		
					...
					if (jsonObject.get("ExpectedHTTPStatusCode").equals(Integer.toString(response.getStatusCode())))
					{ 
						test.log(Status.PASS, "Test is PASS because we expect status code is"+" "+jsonObject.get("ExpectedHTTPStatusCode").toString() +"and actual is "+Integer.toString(response.getStatusCode()));
	...
	public void TCA012() throws IOException, ParseException 
	{           //Validate the response after providing  invalid customerId (int) in request body.
		        
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA012.json");
				...
				//get response
				response = httpsRequest.request(Method.PUT, UtilityClass.getDataFromPF("changeAddressEndPontUrl"));
				System.out.println("12"+response.asString());
	...
	public void TCA017() throws IOException, ParseException 
	{           //Validate the response after providing  invalid<br> postalCode  (alphabet String) in request body.
		        
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA017.json");
				...
				//get response
				response = httpsRequest.request(Method.PUT, UtilityClass.getDataFromPF("changeAddressEndPontUrl"));
				System.out.println("17"+response.asString());
	...
	public void TCA020() throws IOException, ParseException 
	{           //Validate the response after providing  invalid addressType (int) in request body.
		        
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA020.json");
		        ...
		        //get response
				response = httpsRequest.request(Method.PUT, UtilityClass.getDataFromPF("changeAddressEndPontUrl"));
				System.out.println("20"+response.asString());
	...
	public void TCA021() throws IOException, ParseException 
	{           //Validate the response after providing  invalid address1(max+1) 51 character in request body
		        
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA021.json");
				...
				//get response
				response = httpsRequest.request(Method.PUT, UtilityClass.getDataFromPF("changeAddressEndPontUrl"));
				System.out.println("21"+response.asString());
	...
	public void TCA022() throws IOException, ParseException 
	{           //Validate the response after providing  invalid address2(max+1) 51 character in request body
		        
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA022.json");
	...
	public void TCA023() throws IOException, ParseException 
	{           //Validate the response after providing  invalid country (max+1) 21 character in request body.
		       
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA023.json");
		        ...
		        //get response
				response = httpsRequest.request(Method.PUT, UtilityClass.getDataFromPF("changeAddressEndPontUrl"));
				System.out.println("23"+response.asString());
	...
	public void TCA024() throws IOException, ParseException 
	{           //Validate the response after providing  invalid state (max+1) 21 character in request body
		        
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA024.json");
				...
				//get response
				response = httpsRequest.request(Method.PUT, UtilityClass.getDataFromPF("changeAddressEndPontUrl"));
				System.out.println("24"+response.asString());
	...
	public void TCA025() throws IOException, ParseException 
	{           //Validate the response after providing  invalid city (max+1) 21 character in request body
		        
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA025.json");
				...
				//get response
				response = httpsRequest.request(Method.PUT, UtilityClass.getDataFromPF("changeAddressEndPontUrl"));
				System.out.println("25"+response.asString());
	...
	public void TCA026() throws IOException, ParseException 
	{           //Validate the response after providing  invalid <br>postalCode (max+1) 9 integer in request body.
		        
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA026.json");
				...
				//get response
				response = httpsRequest.request(Method.PUT, UtilityClass.getDataFromPF("changeAddressEndPontUrl"));
				System.out.println("26"+response.asString());
	...
	public void TCA027() throws IOException, ParseException 
	{           //Validate the response after providing  invalid addressType (HC) integer in request body
		        
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA027.json");
				...
				//get response
				response = httpsRequest.request(Method.PUT, UtilityClass.getDataFromPF("changeAddressEndPontUrl"));
				System.out.println("27"+response.asString());
	...
	public void TCA028() throws IOException, ParseException 
	{           //Validate the response after providing  invalid <br>addressType (*)  in request body.
		        
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\changeAddress\\TCA028.json");
				...
				//get response
				response = httpsRequest.request(Method.PUT, UtilityClass.getDataFromPF("changeAddressEndPontUrl"));
				System.out.println("28"+response.asString());
