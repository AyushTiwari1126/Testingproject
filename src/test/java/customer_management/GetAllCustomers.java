...
{   String dirPath = System.getProperty("user.dir");
   ...
   @BeforeTest
	...
	public void TGAC001() throws IOException, ParseException 
	{     //Validate the response after providing valid header and valid request body
		
		
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getAllCustomer\\TGAC001.json");
				...
				httpsRequest.headers(HeaderTestCase.getValidHeader(AuthorizationToken));
				
				//get response
				response = httpsRequest.request(Method.POST, UtilityClass.getDataFromPF("getAllCustomerEndPointUrl"));
	...
	{          //Validate the response with ReqDatetime header value blank
		       ...
		       //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getAllCustomer\\TH001.json");
	...
	{           //Validate the response with Sign header value blank
		        ...
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getAllCustomer\\TH002.json");
	...
	{   //Validate the response with Authorization header value blank 
		        ...
		        //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getAllCustomer\\TH003.json");
	...
	{           //Validate the response without ReqDatetime header
		       ...
		       //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getAllCustomer\\TH004.json");
	...
	{          //Validate the response without Sign Header.
		       ...
		       //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getAllCustomer\\TH005.json");
	...
	{           //Validate the response without Authorization header
		         ...
		         //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getAllCustomer\\TH006.json");
	...
	{           //Validate the response after providing  all header  without value
		       ...
		       //read data from json file
				jsonObject=UtilityClass.readDataFromJSONFile(dirPath+"\\Test_Data\\customer-management\\getAllCustomer\\TH007.json");
